...
and both `preserve.eval_run` and `preserve.eval_case` should exist.

## Example MCP server import fails

The example server is a minimal stdio integration for the retrieval
library, not a full appliance.
