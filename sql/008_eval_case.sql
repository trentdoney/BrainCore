...
-- over, but no prior migration created. Fixes launch blocker BL-12.
--
-- Schema derivation (every column traceable to src/eval/gold.ts +
-- src/eval/runner.ts + src/eval/types.ts in /srv/tools/BrainCore as of
-- v1.1.3):
...
-- Closes BL-12: `bun src/cli.ts eval --run` no longer crashes on a fresh
-- clone with `relation "preserve.eval_case" does not exist`.
-- =============================================================================
